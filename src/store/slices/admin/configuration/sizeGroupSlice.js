...
export const getSizeGroups = createAsyncThunk(
    ...
    async (_, {rejectWithValue}) => {
        try{
            const res = await adminAxios.get(apiEndPoints.admin.configuration.sizeGroup)
            return res.data;
        }catch(err){
...
export const addSizeGroup = createAsyncThunk(
    ...
    async (payload, {dispatch, rejectWithValue}) => {
        try{
            const res = await adminAxios.post(apiEndPoints.admin.configuration.sizeGroup, payload);
...
export const updateSizeGroup = createAsyncThunk(
    ...
    async ({id, payload}, {dispatch, rejectWithValue}) => {
        try{
            const res = await adminAxios.patch(`${apiEndPoints.admin.configuration.sizeGroup}/${id}`, payload);
            dispatch(getFormConfig())
            dispatch(getSizeGroups())
            return res.data;
        }catch(err){
...
export const deleteSizeGroup = createAsyncThunk(
    ...
    async (id, {dispatch, rejectWithValue}) => {
        try{
            const res = await adminAxios.delete(`${apiEndPoints.admin.configuration.sizeGroup}/${id}`);
            dispatch(getFormConfig())
            dispatch(getSizeGroups())
            return res.data;
        }catch(err){
