...
export default function ColorCard(){
    ...
    const handleDelete = async () => {
            const res = await dispatch(deleteColor(colorId)).unwrap();
            if(res.status){
    ...
    return (
        ...
        >
            ...
            <ColorModal open={open} onClose={() => setOpen(false)} selectedData={selectedData}/>
                    ...
                    master?.colors.map((row) => {
                        return (
                            <Chip 
                                ...
                                onDelete={() => { setOpenConfirm(true); setColorId(row._id) }}
                                sx={{
